        ...
        <div class="page-content">
            <div class="container">
                ...
                <ul class="page-breadcrumb breadcrumb">
                    ...
                    <li>
                        <span>Pencari Kerja Terdaftar Menurut Jenis Kelamin</span>
                    </li>
                </ul>
                ...
                <div class="modal fade" id="addModal2" tabindex="-1" role="addModal2" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form action="<?php echo base_url('DirektoratPKK/PencariKerjaTerdaftarByJK/UploadExcelByJenisKelamin');?>" method="post"
                                ...
                                <div class="portlet light">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-green-sharp bold uppercase">Pencari Kerja Terdaftar Menurut Jenis Kelamin</span>
                                        </div>
                                        <div class="tools">
                                        ...
                                        <div class="table-toolbar">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6" align="right">
                                                    <form action="<?php echo base_url('DirektoratPKK/PencariKerjaTerdaftarByJK/Search');?>" method="get">
                                                        <div class="input-group input-medium">
                                                            <input type="text" id="key" name="key"
                                                                   class="form-control" placeholder="Search By Tahun">
                                        ...
                                        <div id="sample_1_wrapper" class="dataTables_wrapper no-footer">
                                            ...
                                            <div class="table-scrollable">
                                                ...
                                                <table class="table table-striped table-bordered table-condensed">
                                                    ...
                                                    <?php
                                                    if(is_array($detailpkbyjeniskelaminModel) && count($detailpkbyjeniskelaminModel) ) {
                                                        foreach($detailpkbyjeniskelaminModel as $item){
                                                            ?>
                                                            <tr>
                                                                <td><?=$item->IDTAHUN;?></td>
                                                                <td><?=$item->PRIA;?></td>
