                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">Upload Form Data Jumlah PPTKIS</h4>
                            </div>
                            <form action="<?php echo base_url('DirektoratPTKLN/JumlahPPTKIS/UploadExcel');?>" method="post"
                                ...
                                <div class="portlet light">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-green-sharp bold uppercase">Jumlah PPTKIS</span>
                                        </div>
                                        <div class="tools">
                                        ...
                                        <div class="table-toolbar">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6" align="right">
                                                    <form action="<?php echo base_url('DirektoratPTKLN/JumlahPPTKIS/Search');?>" method="get">
                                            ...
                                            <div class="table-scrollable">
                                                <table class="table table-striped table-bordered table-condensed">
                                                    <tr>
                                                        ...
                                                        <td><strong>Status Cabut</strong></td>
                                                        <td><strong>Status Aktif</strong></td>
                                                        <td><strong>Total</strong></td>
                                                    </tr>
                                                    <?php
                                                    if(is_array($jumlahpptkisModel) && count($jumlahpptkisModel) ) {
                                                        foreach($jumlahpptkisModel as $item){
                                                            ?>
                                                            <tr>
                                                                <td><?=$item->IDTAHUN;?></td>
                                                                <td><?=$item->CABUT;?></td>
