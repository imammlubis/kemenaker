                ...
                <div class="modal fade" id="addModal1" tabindex="-1" role="addModal1" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form action="<?php echo base_url('DirektoratPTKDN/LPTKS/UploadExcel');?>" method="post"
                                ...
                                <div class="portlet light">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-green-sharp bold uppercase">DATA LPTKS</span>
                                        </div>
                                        <div class="tools">
                                        ...
                                        <div id="sample_1_wrapper" class="dataTables_wrapper no-footer">
                                            ...
                                            <div class="table-scrollable">
                                                ...
                                                <table class="table table-striped table-bordered table-condensed">
                                                    ...
                                                    <?php
                                                    if(is_array($lptksModel) && count($lptksModel) ) {
                                                        foreach($lptksModel as $item){
                                                            ?>
                                                            <tr>
