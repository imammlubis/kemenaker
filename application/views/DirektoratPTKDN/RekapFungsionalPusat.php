        ...
        <div class="page-content">
            <div class="container">
                ...
                <ul class="page-breadcrumb breadcrumb">
                    ...
                    <li>
                        <span>Rekap Jabatan Fungsional Pengantar Kerja Pusat</span>
                    </li>
                </ul>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">Upload Form Data Rekap Jabatan Fungsional Pengantar Kerja Pusat</h4>
                            </div>
                            <form action="<?php echo base_url('DirektoratPTKDN/RekapFungsionalPusat/UploadExcel');?>" method="post"
                                ...
                                <div class="portlet light">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-green-sharp bold uppercase">Rekap Jabatan Fungsional Pengantar Kerja Pusat</span>
                                        </div>
                                        <div class="tools">
                                        ...
                                        <div class="table-toolbar">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6" align="right">
                                                    <form action="<?php echo base_url('DirektoratPTKDN/RekapFungsionalPusat/Search');?>" method="get">
                                        ...
                                        <div id="sample_1_wrapper" class="dataTables_wrapper no-footer">
                                            ...
                                            <div class="table-scrollable">
                                                ...
                                                <table class="table table-striped table-bordered table-condensed">
                                                    ...
                                                    <?php
                                                    if(is_array($rekapjabatanfungsionalpusatModel) && count($rekapjabatanfungsionalpusatModel) ) {
                                                        foreach($rekapjabatanfungsionalpusatModel as $item){
                                                            ?>
                                                            <tr>
                                                                <td><?=$item->NAMAPUSAT;?></td>
                                                                <td><?=$item->DUAD;?></td>
                                                                <td><?=$item->TIGAA;?></td>
                                                                <td><?=$item->TIGAB;?></td>
                                                                <td><?=$item->TIGAC;?></td>
