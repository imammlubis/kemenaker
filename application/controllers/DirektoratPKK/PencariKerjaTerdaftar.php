...
class PencariKerjaTerdaftar extends CI_Controller {
    ...
    function index($offset=0)
    {
        if ($this->session->userdata('id')) {
            ...
            //print_r($page);
            $query = $this->DetailPKByProvinsiModel->getDetailPKByProvinsi(10, $this->uri->segment(4));
    ...
    function Search(){
        ...
        if ($this->session->userdata('id')) {
            $config['total_rows'] = $this->DetailPKByProvinsiModel->totalDetailPKByProvinsiSearch($key);
            ...
            $config['num_tag_close'] = '</li>';
            $this->pagination->initialize($config);
            $query = $this->DetailPKByProvinsiModel->getDetailPKByProvinsiSearch(10, $this->uri->segment(4), $key);
