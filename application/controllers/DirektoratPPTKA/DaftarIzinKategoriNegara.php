 ...
 * Time: 14:29
 */
class DaftarIzinKategoriNegara extends CI_Controller
{
    ...
    function index($offset=0)
    {
        ...
        $query = $this->daftarizinmempekerjakantkakategorinegaraModel->get(10,$this->uri->segment(4));
        $data['daftarizinmempekerjakantkakategorinegaraModel'] = null;
        if($query){
    ...
    function UploadExcel(){
        ...
        $this->db->empty_table('daftarizinmempekerjakantkakategorinegara');
        ...
        for ($i = 2; $i<=$objPHPExcel->setActiveSheetIndex(0)->getHighestRow(); $i++) {
            ...
            for($y=1; $y<$highestColumnIndex; $y++) {
                ...
                $dataInput = array(
                    'TAHUN' => $tahun,
                    'JUMLAH' => $jumlah,
                    'NEGARA' => $sektorKategori
                );
                $this->daftarizinmempekerjakantkakategorinegaraModel->add($dataInput);
            }

        }
        redirect('DirektoratPPTKA/DaftarIzinKategoriNegara');
    }
}